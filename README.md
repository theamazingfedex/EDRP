# EDRP - Elite Dangerous Route Planner
###### By Daniel Wood

#### The Idea
  1. Select multiple System/Station combinations to create the most profitable route amongst them.
    1. Provide basic information
       * Input origin station
        * Add implicit or excluded materials
       * Input max jump-range
       * Input max carry-weight
       * Max station distance(from star)
       * Include Planetary?(optional)
  2. Find a profitable trade loop which passes through the given system
    1. Manual Loop Finder
       * Add `n` stops on the loop
        * Add station/system name
        * Add implicit/explicit commodities
    2. Automated Loop Finder
       * Add max-number of jumps
       * Add optional destination system/station
       * Add landing pad size
